function pizzaCart() {
  return {
    ...
    addPizza(pizzaId) {
      console.log('addPizza - this.cartId:', this.cartId); 
      return axios.post(
    ...
    showCartData() {
      this.getCart().then((result) => {
        ...
        console.log('showCartData - this.cartId:', this.cartId); // Debugging line
      });
    },
    init() {
      axios
    ...
    addPizzaToCart(pizzaId) {
      console.log('addPizzaToCart - this.cartId before addPizza:', this.cartId); // Debugging line
